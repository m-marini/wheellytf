...
from wheelly.tdlayers import (TDDense, TDRelu, TDSoftmax, TDState, TDTanh, create_graph,
                              create_layers_props,
                              flat_type_spec, parse_for_inputs, parse_for_size,
                              sort_layers, validate_output)
...
def test_create_layers_props():
    ...
    assert isinstance(result["output"]["temperature"], tf.Variable)
...
def test_create_network():
    ...
    result = TDState.create(net_spec=net_spec,
